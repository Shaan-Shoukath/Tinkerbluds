...
| [03_earth_engine_pipeline.md](03_earth_engine_pipeline.md) | **Earth Engine Pipeline** — Sentinel-2 NDVI, Sentinel-1 SAR radar (what/how/why), SRTM terrain, WorldCover classification, NDVI temporal stddev, batched computation, thumbnail generation                                                                                |
| [04_validation_scoring.md](04_validation_scoring.md)       | **Validation & Scoring** — XGBoost ML classifier (8 features), fused optical+SAR threshold fallback, feature importance, PASS/REVIEW/FAIL thresholds, yield feasibility integration, worked examples                                                                      |
...
3. **Earth Engine** (03) — S2 optical + S1 SAR radar + terrain
4. **Scoring** (04) — ML classifier + threshold fallback
